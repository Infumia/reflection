...
public interface RefAnnotated {
   ...
   *
   * @return the given annotation class's instance if {@code this} have the given annotation class.
   */
  @NotNull <A extends Annotation> Optional<A> getAnnotation(@NotNull Class<A> annotationClass);
  ...
  /**
   * gets the annotations from the given annotation class.
   *
   * @param annotationClass the annotation class to get.
   * @param <A> the annotation type.
   *
   * @return the given annotation class's instances if {@code this} have the given annotation class.
   */
  @NotNull <A extends Annotation> Collection<A> getAnnotations(@NotNull Class<A> annotationClass);
